    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-header bg-success text-white">
                <strong>Usuarios</strong> &nbsp; &nbsp; <router-link :to="{ name: 'usuariocrear', params: {idu: this.$route.params.idu} }" class="btn btn-warning btn-sm">Nuevo&nbsp; &nbsp; <i class="fa-solid fa-plus"></i></router-link>
            </div>
            <div class="card-body">
                    ...
                    <table class="display table table-bordered table-hover">
                        ...
                        <tbody >
                            <tr v-for="dato in mostrardatos" :key="dato.id">
                                ...
                                <td>{{ dato.apellido }}</td>
                                <td>{{ dato.email }}</td>
                                <td> <center><router-link :to="{ name: 'usuarioeditar', params: { id: dato.id, idu: this.$route.params.idu} }"
